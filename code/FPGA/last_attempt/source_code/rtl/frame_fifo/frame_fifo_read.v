...
begin
	...
	begin
        ...
        if (state == S_ACK) 
        begin
        case (read_addr_index_d1)      // 搬到 S_IDLE,似乎没用
        2'd0: App_rd_addr_r <= read_addr_0;
        2'd1: App_rd_addr_r <= read_addr_1;
        2'd2: App_rd_addr_r <= read_addr_2;
        2'd3: App_rd_addr_r <= read_addr_3;
        endcase
        end
		else if(App_rd_en)
